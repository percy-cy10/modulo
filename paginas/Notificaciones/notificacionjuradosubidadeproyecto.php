...
$sqlData = "SELECT
                ...
                WHERE
                t.id = $ids"; // Incluimos los campos "id", "Celular" y "Email" en la consulta
...
if ($resultData->num_rows > 0) {
    while ($row = $resultData->fetch_assoc()) {
        $destinatarios[] = array(
            'id' => $row['id_jurados'], // Almacenamos el Jurado_Id en el array de destinatarios
...
$asunto = 'Asunto: Subida del Proyecto de Tesis';
$mensajeTexto = '
Estimado Jurado,
...
$subject = 'Notificacion de Subida del Proyecto de Tesis';
$message = '
Estimado Jurado,
