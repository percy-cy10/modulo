        ...
        <div class="section1 ">
            <div class="section-btn-subir ">
                ...
                <form>
                    ...
                    <label class="label-inp" type="text" id="nombre" name="nombre" required placeholder="Revisión de Formato del Proyecto Tesis - Coordinador">Revisión de Formato del Proyecto Tesis - Coordinador</label>
                </form>
