  ...
  <div class="content">
    <div class="left-column">
        <div class="section1 ">
            <div class="section-btn-subir ">
                ...
                <form>
                    ...
                    <label class="label-inp" type="text" id="nombre" name="nombre" required >Proyecto Tesis en Dictamen</label>
        ...
        <div class="section">
            ...
            <div class="contenido">
                <p class="titulo1"><a class="etiq-a-s" href="./pagina6.php">Proyecto Aprobado</a></p>
                <p class="conenid-titulo">
